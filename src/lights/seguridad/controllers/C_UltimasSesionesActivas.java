package lights.seguridad.controllers;
...
import lights.seguridad.viewmodels.VMUltimasSesionesActivas;
...
public class C_UltimasSesionesActivas extends C_WindowDialog {
	...
	public void updateListBoxAndFooter(Integer page, HowToSeeEnum howToSeeEnum) {
		PayloadSesionResponse iPayload = ((VMUltimasSesionesActivas) vm()).updateListBox(page, howToSeeEnum);
