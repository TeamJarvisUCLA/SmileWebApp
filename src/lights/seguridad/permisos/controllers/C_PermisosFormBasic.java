package lights.seguridad.permisos.controllers;
...
import lights.seguridad.MenuTreeFullPermisos;
import lights.seguridad.ToolbarPermisos;
...
import lights.seguridad.permisos.viewmodels.VM_PermisosFormBasic;
...
public class C_PermisosFormBasic extends C_WindowForm {
	...
	private MenuTreeFullPermisos tree;
	...
	public void onSelectButtonToolbar$tree(Event event) throws InterruptedException {
		...
		ToolbarPermisos toolbarPermisos = (ToolbarPermisos) data.get("toolbar");
