...
public class VM_AyudaFormBasic extends VM_WindowForm {
	...
	public boolean isFormValidated() {
		// TODO
		try {
			UtilValidate.validateString(getAyuda().getNombre(), "Nombre", 100);
			UtilValidate.validateString(getAyuda().getDescripcion(),
					"Descripción", 250);
			return true;
		} catch (Exception e) {
