...
public class VM_EgresoPadrinoIndex extends VM_WindowWizard<Padrino> {
	...
	// PADRINO
		...
		public List<EstatusPadrinoEnum> getEstatusPadrinoEnums()
		{
			...
			{
				for (EstatusPadrinoEnum estatusPadrinoEnum : EstatusPadrinoEnum.values())
				{
		...
		public void setEstatusPadrinoEnums(List<EstatusPadrinoEnum> estatusPadrinoEnums)
		{
		...
		{
			// RECHAZADO
			this.selectedObject.setEstatusPadrino(EstatusPadrinoEnum.INACTIVO.ordinal());
			goToNextStep();
			return "";
		}
