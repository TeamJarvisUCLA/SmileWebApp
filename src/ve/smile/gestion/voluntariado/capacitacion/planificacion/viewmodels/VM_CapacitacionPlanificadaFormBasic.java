...
public class VM_CapacitacionPlanificadaFormBasic extends VM_WindowForm {
	...
	public boolean isFormValidated()
	{
		try
		{
			...
			UtilValidate.validateString(getCapacitacionPlanificada().getObservacion(), "Observaciones", 250);
			return true;
		}
		catch (Exception e)
		{
