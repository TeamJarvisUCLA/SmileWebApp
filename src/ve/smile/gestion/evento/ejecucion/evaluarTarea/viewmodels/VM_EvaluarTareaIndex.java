...
public class VM_EvaluarTareaIndex extends VM_WindowWizard{
	...
	public String isValidPreconditionsFinalizar(Integer currentStep) {
			...
			for (EventPlanTarea eventPlanTarea : this
				...
				if(eventPlanTarea.getFechaEjecutada() == null){
					return "E:Error code 5- Debe suministrar la fecha de ejecución de la tarea";
				}
...
//				return "E:Error Code 5-Debe verificar la  <b> Fecha de EjecuciÃ³n </b> de los siguientes tareas: <b>"
//						+ tareas + "</b>";
//			}
