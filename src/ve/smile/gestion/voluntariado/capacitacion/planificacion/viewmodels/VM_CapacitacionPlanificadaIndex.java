...
public class VM_CapacitacionPlanificadaIndex extends VM_WindowWizard <Capacitacion>
{
	...
	public String executeFinalizar(Integer currentStep)
	{
		if (currentStep == 2)
		{
			this.getCapacitacionPlanificada().setFkCapacitacion(this.getCapacitacionSelected());
			...
			PayloadCapacitacionPlanificadaResponse payloadCapacitacionPlanificadaResponse = S.CapacitacionPlanificadaService.modificar(this.getCapacitacionPlanificada());
