...
public class VM_FortalezaFormBasic extends VM_WindowForm {
	...
	public boolean isFormValidated() {
		...
		try {
			UtilValidate.validateString(getFortaleza().getNombre(), "Nombre",
					100);
			UtilValidate.validateString(getFortaleza().getDescripcion(),
					"Descripción", 250);
