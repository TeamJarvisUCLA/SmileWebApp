...
public class VMPClasificadorRecurso extends VM_WindowSimpleListPrincipal<ClasificadorRecurso> {
	...
	public IPayloadResponse<ClasificadorRecurso> getDataToTable(
		...
		PayloadClasificadorRecursoResponse payloadClasificadorRecursoResponse = 
				S.ClasificadorRecursoService.consultarPaginacion(cantidadRegistrosPagina, pagina);
	...
	public void doDelete() {
		PayloadClasificadorRecursoResponse payloadClasificadorRecursoResponse =
				S.ClasificadorRecursoService.eliminar(getSelectedObject().getIdClasificadorRecurso());
