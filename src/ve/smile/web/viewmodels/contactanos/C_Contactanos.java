...
public class C_Contactanos extends C_WindowDialog {
	...
	public void onAccept(Event event) {
		...
		ContactoPortal contactoPortal = incluirContactanosContacto
				.getContactoPortal();
		ClasificadorSugerencia cSugerencia = incluirContactanosContacto
				.getcSugerencia();
		...
		comunidad.setApellido(incluirContactanosContacto.getComunidad()
				.getApellido());
		comunidad.setCorreo(incluirContactanosContacto.getComunidad()
				.getCorreo());
		comunidad.setNombre(incluirContactanosContacto.getComunidad()
				.getNombre());

		PayloadContactoPortalResponse payloadContactoPortalResponse = S.ContactoPortalService
				.incluirContactoPortal(contactoPortal);

		incluirContactanosContacto.limpiar();
