...
public class VM_EvaluacionSolicitudIndex extends VM_WindowSimpleListPrincipal<SolicitudAyuda> {
	...
	public String getSrcFileZulForm(OperacionEnum operacionEnum) {
		return "views/desktop//gestion/ayudas/egresoSolicitudAyuda/SolicitudesFormBasic.zul";
	}
