...
public class VM_ParentescoFormBasic extends VM_WindowForm {
	...
	public boolean isFormValidated() {
		try {
			UtilValidate.validateString(getParentesco().getNombre(), "Nombre",
					100);
			return true;
		} catch (Exception e) {
