...
public class VM_CatalogoMotivo extends VM_ListPaginationCatalogueDialog<Motivo>
{
	...
	@Override
	public IPayloadResponse<Motivo> getObjectListToLoad(Integer cantidadRegistrosPagina, Integer pagina)
	{
		PayloadMotivoResponse payloadMotivoResponse = S.MotivoService.consultarPaginacion(cantidadRegistrosPagina, pagina);
