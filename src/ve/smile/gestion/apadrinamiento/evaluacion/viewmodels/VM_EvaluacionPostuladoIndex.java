...
public class VM_EvaluacionPostuladoIndex extends VM_WindowSimpleListPrincipal<Padrino>{
	...
	public String getSrcFileZulForm(OperacionEnum operacionEnum) {
		return "views/desktop/gestion/apadrinamiento/evaluacion/EvaluacionPostuladoIndex.zul";
	}
