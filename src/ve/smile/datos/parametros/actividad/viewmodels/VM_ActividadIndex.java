...
public class VM_ActividadIndex extends VM_WindowSimpleListPrincipal<Actividad> {
	...
	public String isValidPreconditionsEliminar() {
		...
		if (countTsPlanActividadVoluntarios > 0) {
			return "E:Error 0:No se puede eliminar la <b>Actividad</b> seleccionada ya que está siendo utilizada en " + countTsPlanActividadVoluntarios + " Trabajo Social Planificado Voluntarios";
		}
