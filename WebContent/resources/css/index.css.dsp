...
.nav-user > div > a.white.open,
.nav-user > div .user-menu.white.open,
.nav-user > div > a.white:hover,
.nav-user > div .user-menu.white:hover,
.nav-user > div > a.white:focus,
.nav-user > div .user-menu.white:focus,
.nav-user > div > a.white .z-menu-selected,
.nav-user > div .user-menu.white .z-menu-selected {
...
.nav-list.z-navbar > ul > li > a:hover {
  background-color:  rgb(236, 241, 188);
 /* color: #7cb7ec;*/
}
...
.nav-list.z-navbar > ul .z-navitem-selected > .z-navitem-content > i {
    color: #7cb7ec;
}
...
.z-button:hover,
.z-button:focus, .btn-sm:hover, .btn-sm:active { 
  border:none ;
  -webkit-box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.18), 0 4px 15px 0
		rgba(0, 0, 0, 0.15);
	-moz-box-shadow: 0 5px 11px 0 rgba(0, 0, 0, 0.18), 0 4px 15px 0
		rgba(0, 0, 0, 0.15);
