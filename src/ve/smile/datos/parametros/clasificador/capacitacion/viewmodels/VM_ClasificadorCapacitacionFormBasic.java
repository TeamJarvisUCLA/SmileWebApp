...
public class VM_ClasificadorCapacitacionFormBasic extends VM_WindowForm {
	...
	public boolean actionGuardar(OperacionEnum operacionEnum) {
		...
		if (operacionEnum.equals(OperacionEnum.INCLUIR)) {
			PayloadClasificadorCapacitacionResponse payloadClasificadorCapacitacionResponse = S.ClasificadorCapacitacionService
					.incluir(getClasificadorCapacitacion());
		...
		if (operacionEnum.equals(OperacionEnum.MODIFICAR)) {
			PayloadClasificadorCapacitacionResponse payloadClasificadorCapacitacionResponse = S.ClasificadorCapacitacionService
					.modificar(getClasificadorCapacitacion());
	...
	public boolean isFormValidated() {
		try {
			UtilValidate.validateString(getClasificadorCapacitacion()
