...
public class TreemapLargeComposer extends SelectorComposer<Window> {
    ...
    private Point[] getData() {
        ...
        int regionId = 0;
        for (Object regionName : obj.keySet()) {
            JSONObject region = (JSONObject) obj.get(regionName);
            ...
            for (Object countryName : region.keySet()) {
                ...
                for (Object causeName : country.keySet()) {
                    double cause = Double.parseDouble((String) country.get(causeName));
                    ...
                    causePt.setValue(Math.round(cause));
